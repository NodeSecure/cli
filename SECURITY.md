...
To report a security issue, please email `gentilhomme.thomas@gmail.com` with a description of the issue, the steps you took to create the issue, affected versions, and, if known, mitigations for the issue.

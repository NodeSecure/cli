...
export class PackageInfo {
  ...
  initialize() {
    ...
    const bundlephobia = document.createElement("bundle-phobia");
    bundlephobia.packageInfo = { name: this.dependencyVersion.name, version: this.dependencyVersion.version };
